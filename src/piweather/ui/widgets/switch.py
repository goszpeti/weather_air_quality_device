"""
Code from Stefan Scherfke, https://stackoverflow.com/questions/14780517/toggle-switch-in-qt
Licensed under Creative Commons. NOT FOR OSS RELEASE!
"""
...
class Switch(QAbstractButton):
    ...
    def paintEvent(self, event):  # pylint: disable=invalid-name, unused-argument
        ...
        if self.isEnabled():
            ...
            #track_opacity *= 0.3
            track_brush = self.palette().dark()
            thumb_brush = self.palette().dark()
        ...
        font = painter.font()
        font.setPixelSize(float(1.5 * self._thumb_radius))
